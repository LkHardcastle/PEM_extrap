...
extrap1 = barker_extrapolation(out1, priors1.diff, priors1.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap)
...
extrap1 = barker_extrapolation(out2, priors2.diff, priors2.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap)
...
extrap1 = barker_extrapolation(out3, priors3.diff, priors3.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap)
