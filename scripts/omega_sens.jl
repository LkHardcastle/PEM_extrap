...
histogram(vec(out1["Smp_h"][2,:]))
histogram!(vec(out2["Smp_h"][2,:]))
plot(vec(out1["Smp_h"][2,:]))
plot(scatter(vec(out1["Smp_h"][1,:]),vec(out1["Smp_h"][2,:])))
plot(scatter(vec(out2["Smp_h"][1,:]),vec(out2["Smp_h"][2,:])))
histogram!(out2["Smp_h"])
plot(quantile(out1["Smp_h"], 0.01:0.01:0.99),quantile(Beta(5,15),0.01:0.01:0.99))
plot(quantile(out2["Smp_h"], 0.01:0.01:0.99),quantile(Beta(10,10),0.01:0.01:0.99))
plot!(out2["Smp_h"])
plot(out3["Smp_h"])
plot(out4["Smp_h"])
