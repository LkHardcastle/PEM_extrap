...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsPois(7.0, 1.0, 100.0, 3.1), [GammaLangevin(2,7)], [0.1])
out3 = pem_fit(state0, dat, priors, settings, test_times)
println(out3[3]);println(out3[4])
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsPois(7.0, 1.0, 100.0, 3.1), [GompertzBaseline(0.5)], [0.1])
out4 = pem_fit(state0, dat, priors, settings, test_times)
println(out4[3]);println(out4[4])

priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [RandomWalk()], [0.1])
out5 = pem_fit(state0, dat, priors, settings, test_times)
println(out5[3]);println(out5[4])
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [GaussLangevin(log(0.2),1.0)], [0.1])
out6 = pem_fit(state0, dat, priors, settings, test_times)
println(out6[3]);println(out6[4])
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [GammaLangevin(2,7)], [0.1])
out7 = pem_fit(state0, dat, priors, settings, test_times)
println(out7[3]);println(out7[4])
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [GompertzBaseline(0.5)], [0.1])
...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsPois(7.0, 1.0, 100.0, 3.1), [RandomWalk()], [0.1])
extrap1 = barker_extrapolation(out1[1], priors.diff[1], priors.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap, 1)
...
extrap1 = barker_extrapolation(out2[1], priors.diff[1], priors.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap, 1)
s1 = vcat(view(exp.(test_smp), 1, :, :), view(exp.(extrap1), :, :))
...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsPois(7.0, 1.0, 100.0, 3.1), [GammaLangevin(2,7)], [0.1])
extrap1 = barker_extrapolation(out3[1], priors.diff[1], priors.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap, 1)
s1 = vcat(view(exp.(test_smp), 1, :, :), view(exp.(extrap1), :, :))
...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsPois(7.0, 1.0, 100.0, 3.1), [GompertzBaseline(0.5)], [0.1])
extrap1 = barker_extrapolation(out4[1], priors.diff[1], priors.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap, 1)
s1 = vcat(view(exp.(test_smp), 1, :, :), view(exp.(extrap1), :, :))
...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [RandomWalk()], [0.1])
extrap1 = barker_extrapolation(out5[1], priors.diff[1], priors.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap, 1)
s1 = vcat(view(exp.(test_smp), 1, :, :), view(exp.(extrap1), :, :))
...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [GaussLangevin(log(0.2),1.0)], [0.1])
extrap1 = barker_extrapolation(out6[1], priors.diff[1], priors.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap, 1)
s1 = vcat(view(exp.(test_smp), 1, :, :), view(exp.(extrap1), :, :))
...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [GammaLangevin(2,7)], [0.1])
extrap1 = barker_extrapolation(out7[1], priors.diff[1], priors.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap, 1)
s1 = vcat(view(exp.(test_smp), 1, :, :), view(exp.(extrap1), :, :))
...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [GompertzBaseline(0.5)], [0.1])
extrap1 = barker_extrapolation(out8[1], priors.diff[1], priors.grid, breaks_extrap[begin], breaks_extrap[end] + 0.1, breaks_extrap, 1)
s1 = vcat(view(exp.(test_smp), 1, :, :), view(exp.(extrap1), :, :))
