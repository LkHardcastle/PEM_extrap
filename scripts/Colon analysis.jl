...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsPois(7.0, 1.0, 100.0, 3.1), [GaussLangevin(log(0.5),0.4)], [0.1], 2)
...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsPois(7.0, 1.0, 100.0, 3.1), [GammaLangevin(4,14)], [0.1], 2)
...
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [GaussLangevin(log(0.5),0.4)], [0.1], 2)
out6 = pem_fit(state0, dat, priors, settings, test_times)
println(out6[3]);println(out6[4])
priors = BasicPrior(1.0, PC([1.0], [2], [0.5], Inf), FixedW([0.5]), 1.0, CtsNB(7.0, 1.0, 7.0, 1.0, 100.0, 3.1), [GammaLangevin(4,14)], [0.1], 2)
