...
priors = BasicPrior(1.0, FixedV(1.0), FixedW(0.5), 0.0, Fixed(), GaussLangevin(0.0, 0.5))
@time out1 = pem_sample(state0, dat, priors, settings)
settings = Settings(nits, nsmp, 1_000_000, 1.0,1.0, 0.5, false, true)
priors = BasicPrior(1.0, FixedV(0.5), FixedW(0.5), 0.0, Fixed(), GaussLangevin(0.0, 0.5))
@time out2 = pem_sample(state0, dat, priors, settings)
settings = Settings(nits, nsmp, 1_000_000, 1.0,1.0, 0.5, false, true)
priors = BasicPrior(1.0, FixedV(0.1), FixedW(0.5), 0.0, Fixed(), GaussLangevin(0.0, 0.5))
@time out3 = pem_sample(state0, dat, priors, settings)
settings = Settings(nits, nsmp, 1_000_000, 1.0,1.0, 0.5, false, true)
priors = BasicPrior(1.0, FixedV(0.01), FixedW(0.5), 0.0, Fixed(), GaussLangevin(0.0, 0.5))
@time out4 = pem_sample(state0, dat, priors, settings)

Random.seed!(12515)
settings = Settings(nits, nsmp, 1_000_000, 1.0,1.0, 0.5, false, true)
priors = BasicPrior(1.0, FixedV(0.5), FixedW(0.5), 0.0, Fixed(), RandomWalk())
@time out1 = pem_sample(state0, dat, priors, settings)
